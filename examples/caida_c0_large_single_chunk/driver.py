...
if __name__ == '__main__':
    ...
    generator.train(work_folder='../../results/caida_c0_large_1-100', preprocess=False, train=True)
    generator.generate(work_folder='../../results/caida_c0_large_1-100')
    # generator.visualize(work_folder='../../results/caida_c0_1-100', port=8056)
    # find available port starting from 8050
    # port = 8056
    # while port < 8500:
    #     try:
    #         generator.visualize(work_folder='../../results/caida_c0_small_1-100', port=port)
    #         break
    #     except Exception:
    #         port += 1 
